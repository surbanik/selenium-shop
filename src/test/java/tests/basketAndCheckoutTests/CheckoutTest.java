...
public class CheckoutTest extends TestBase {
    ...
    public void checkoutTest() throws InterruptedException {
        ...
        assertTrue(confirmationPage.isProductDetailsAreCorrect(basket));
        ...
        assertTrue(orderHistoryPage.isOrderDetailsAreCorrect(orderDetails, basket));

        orderHistoryPage
                .goToOrderDetailsPage(orderDetails);

        assertTrue(orderDetailsPage.isProductDetailsAreCorrect(basket));
